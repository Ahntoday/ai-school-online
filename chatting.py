...
def get_frequent_user(user_data, users_number):
    table = fill_frequency_table(user_data, users_number)
...
def fill_frequency_table(user_data, users_number):
    print(user_data)
    table = {}
    for user in user_data:
        table[user] = 0
...
def main():
    ...
    n = len(user_data)
    answer = get_frequent_user(user_data, n)
    print(answer)
